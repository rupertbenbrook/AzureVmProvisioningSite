...
intellisense.annotate(jQuery.fn, {
  ...
  'finish': function() {
    /// <signature>
    ///   <summary>StopAsync the currently-running animation, remove all queued animations, and complete all animations for the matched elements.</summary>
  ...
  'stop': function() {
    /// <signature>
    ///   <summary>StopAsync the currently-running animation on the matched elements.</summary>
